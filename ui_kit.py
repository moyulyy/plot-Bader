...
QTableWidget {
    background: $card; alternate-background-color: $field;
    border: 1px solid $card_border; border-radius: 10px;
    color: $text; gridline-color: $card_border; outline: none;
    selection-background-color: $list_sel; selection-color: #FFFFFF;
}
QTableWidget::item { padding: 5px 10px; border: none; }
QTableWidget::item:selected { background: $list_sel; color: #FFFFFF; }
QHeaderView::section {
    background: $field; color: $text_dim; border: none;
    border-bottom: 1px solid $card_border; padding: 7px 10px;
